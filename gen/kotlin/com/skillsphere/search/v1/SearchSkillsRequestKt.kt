...
public inline fun searchSkillsRequest(block: com.skillsphere.search.v1.SearchSkillsRequestKt.Dsl.() -> kotlin.Unit): com.skillsphere.search.v1.SearchSkillsRequest =
  com.skillsphere.search.v1.SearchSkillsRequestKt.Dsl._create(com.skillsphere.search.v1.SearchSkillsRequest.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `skillsphere.search.v1.SearchSkillsRequest`
 */
public object SearchSkillsRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.skillsphere.search.v1.SearchSkillsRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.skillsphere.search.v1.SearchSkillsRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.skillsphere.search.v1.SearchSkillsRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.skillsphere.search.v1.SearchSkillsRequest.copy(block: `com.skillsphere.search.v1`.SearchSkillsRequestKt.Dsl.() -> kotlin.Unit): com.skillsphere.search.v1.SearchSkillsRequest =
  `com.skillsphere.search.v1`.SearchSkillsRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
